...
<?php foreach ($guru as $gurus) : ?>
  ...
  <div class="modal fade" id="modalFormEdit<?php echo $gurus->NUPTK ?>" tabindex="-1" role="dialog" aria-labelledby="mediumModalLabel" aria-labelledby="largeModal" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
