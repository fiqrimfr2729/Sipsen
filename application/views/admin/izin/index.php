                ...
                <div class="panel-body">
                    <div class="col-md-12">
                        ...
                        <p class="animated fadeInDown">
                            Dashboard <span class="fa-angle-right fa"></span> Izin <span class="fa-angle-right fa"></span> Data Izin
                        </p>
                    </div>
                </div>
            </div>
                ...
                <div class="col-md-12">
                    <div class="panel">
                        ...
                        <div class="form-group" style="margin-top:10px; margin-left:10px;">
                            <a href="<?php echo base_url(''); ?>izin/form" class="btn btn-raised btn-success"><i class="fas fa-plus"></i> Tambah data</a>
                        </div>
                        <div class="panel-body">
