          ...
          <form action="<?php echo base_url() . 'siswa/edit' ?>" method="post">
            ...
            <div class="form-group">
              <label for="tgl_lahir">Tanggal Lahir :
                <input type="date" id="tgl_lahir" class="form-text form-control" placeholder="<?php echo $siswas->tgl_lahir ?>" value="<?php echo $siswas->tgl_lahir ?>" aria-describedby="basic-addon2" name="tgl_lahir">Tahun/Bulan/Tanggal
            </div>
