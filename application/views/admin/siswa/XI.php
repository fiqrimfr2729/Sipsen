<div class="col-md-12">
  <div class="panel">
    ...
    <div class="form-group" style="margin-top:10px; margin-left:10px;">
      <a class="btn btn-raised btn-success" href="<?php echo base_url(''); ?>s<a class=" btn btn-raised btn-success" href="<?php echo base_url(''); ?>siswa/form"><i class="fas fa-plus"></i> Tambah data</a>
    </div>
          ...
          <tbody>
            ...
            ?>
                <tr>
                  ...
                  <td>
                    <a data-target="#modalFormDetailXI<?php echo $siswas->NIS ?>" data-toggle="modal" class=" btn ripple-infinite btn-info" data-placement="top" title="Detail"><span class="fas fa-list"></span></a>
                    <a data-target="#modalFormEditXI<?php echo $siswas->NIS ?>" data-toggle="modal" class=" btn  ripple-infinite btn-primary" data-placement="top" title="Ubah"><span class="fas fa-edit"></span></a>
                    <a data-target="#modalResetPWDXI<?php echo $siswas->NIS ?>" data-toggle="modal" class=" btn  ripple-infinite btn-info" data-placement="top" title="Reset Password"><span class="fas fa-sync"></span></a>
                    <a data-target="#modalHapusGuruXI<?php echo $siswas->NIS ?>" data-toggle="modal" class=" btn  ripple-infinite btn-danger" data-placement="top" title="Hapus"><span class="fas fa-trash"></span></a>
                  </td>
                </tr>
            <?php endif;
            endforeach; ?>
...
<?php foreach ($siswa as $siswas) : ?>
  ...
  <div class="modal fade" id="modalFormDetailXI<?php echo $siswas->NIS ?>" tabindex="-1" role="dialog" aria-labelledby="mediumModalLabel" aria-labelledby="largeModal" aria-hidden="true">
  ...
  <div class="modal fade" id="modalHapusSiswaXI<?php echo $siswas->NIS ?>" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
  ...
  <div class="modal fade" id="modalFormEditXI<?php echo $siswas->NIS ?>" tabindex="-1" role="dialog" aria-labelledby="mediumModalLabel" aria-labelledby="largeModal" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <form class="form-horizontal" method="post" action="<?php echo base_url() . 'siswa/resetPWD' ?>">
          <div class="modal-body">
            <p>Anda yakin mau mereset password Siswa <b><?php echo $siswas->nama; ?> ?</b></p>
          </div>
          <div class="modal-footer">
            <input type="hidden" name="NIS" value="<?php echo $siswas->NIS; ?>">
            <button class="btn" data-dismiss="modal" aria-hidden="true">Tutup</button>
